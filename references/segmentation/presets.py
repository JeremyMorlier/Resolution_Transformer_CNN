...
class SegmentationPresetTrain:
    def __init__(
        ...
        *,
        ...
        transforms += [T.RandomResize(min_size=low_size, max_size=high_size)]
        ...
        # new transformations
        if aug_mode == "randaug_reduced" :
            transforms += [T.RandAugment(2, 0.2, "reduced",prob=1.0, fill=255, ignore_value=255)]
