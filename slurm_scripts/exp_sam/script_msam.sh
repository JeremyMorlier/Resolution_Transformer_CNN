...
srun python3 distillation_sam.py --optim adamw  --model mobilesam_vit --learning_rate 0.001 --weight_decay 0.0005 --epochs 8 --batch_size 2 --sam_checkpoint $WORK/data/sam_vit_h_4b8939.pth --output_dir $WORK/results_sam/ --root_feat $WORK/data/SAM_Features --dataset_path $DSDIR/SegmentAnything_1B --ade_dataset $SCRATCH/ADE20K/ --val_dirs sa_000021 --train_dirs sa_000022  sa_000024  sa_000030  sa_000031  sa_000032  sa_000033  sa_000034  sa_000035  sa_000036  sa_000037